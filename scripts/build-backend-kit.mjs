...
const pkgDir = path.resolve(root, "packages", "backend-kit");
...
if (entryPoints.length === 0) {
  throw new Error("[build-backend-kit] No TypeScript source files found");
}
...
console.log("[build-backend-kit] Built to packages/backend-kit/dist");
